...
class Video extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      appid:"470628f3c67d40e79670907befd8fe33", //Enter the App ID generated from the Agora Website
      channelName: this.props.navigation.getParam('channel'), //Channel Name for the current session
